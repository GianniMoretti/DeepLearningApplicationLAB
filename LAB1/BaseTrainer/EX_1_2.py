...
config_file_name = "config_EX_1_2.yaml"
...
# Create model
model = myModels.ResidualMLP(32 * 32 * 3, block_dims = [128, 128, 128, 128, 128], dim_output = 10)
#model = myModels.MLP(32 * 32 * 3, hidden_layers = [64, 128, 128, 64, 128], output_dim = 10)
...
trainset = torchvision.datasets.CIFAR10(root=configr['database_path'], train=True, download=True, transform=transform_train)
print("Trainset shape: "+ Fore.GREEN + f"{trainset.data.shape}")

# Test loader settings
print(Fore.CYAN + "Testset loading:")
testset = torchvision.datasets.CIFAR10(root=configr['database_path'], train=False, download=True, transform=transform_test)
